...
public class MainActivity extends AppCompatActivity implements ContactAdapter.ContactsAdapterListener {
    ...
    private void fetchContacts() {
        ...
        MyAppliction.getmInstance().addToRequestQueue(request);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //listening to the search query text change
    ...
    public void onBackPressed() {
        //close the searche view on back button prressed
